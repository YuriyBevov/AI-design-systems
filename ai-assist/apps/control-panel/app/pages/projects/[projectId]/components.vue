...
const iconSamples = [
  ...
  { name: "play", label: "Запустить или продолжить" },
  { name: "pause", label: "Приостановить" },
  { name: "stop", label: "Остановить" },
  { name: "refresh", label: "Обновить или повторить" },
  { name: "archive", label: "В архив" },
  { name: "restore", label: "Вернуть из архива" },
  { name: "eye", label: "Смотреть" },
  { name: "publish", label: "Опубликовать" },
  { name: "unpublish", label: "Снять с публикации" },
