...
function Qt(e, n, i = t) {
	...
	return u && u(w), m = new Oe(g), m.scheduler = l ? () => l(w, !1) : w, v = (e) => Zt(e, !1, m), _ = m.onStop = () => {
		let e = Yt.get(m);
		if (e) {
			if (f) f(e, 4);
...
function kn(e, t, n) {
	...
	let o = Xi(this), s = On(i, a.bind(r), n);
	return o(), s;
}
function An(e, t) {
	let n = t.split(".");
...
function Fn(e) {
	if (!Gn(e)) return Mn(e.type) && e.children ? Pn(e.children) : e;
...
function Hn(e, n, r, a, o = !1) {
	...
	let s = a.shapeFlag & 4 ? oa(a.component) : a.el, l = o ? null : s, { i: f, r: p } = e, m = n && n.r, _ = f.refs === t ? f.refs = {} : f.refs, v = f.setupState, y = /* @__PURE__ */ L(v), b = v === t ? i : (e) => !Bn(_, e) && u(y, e), x = (e, t) => !(t && Bn(_, t));
	if (m != null && m !== p) {
...
function gr(e) {
	...
	if (k(Qn, p), k($n, m), k(er, g), k(tr, _), k(Kn, y), k(qn, b), k(sr, E), k(or, ee), k(ar, te), k(nr, S), k(rr, w), k(ir, ne), d(D)) {
		if (D.length) {
			let t = e.exposed ||= {};
			D.forEach((e) => {
	...
	T && e.render === r && (e.render = T), re != null && (e.inheritAttrs = re), ie && (e.components = ie), O && (e.directives = O), ne && zn(e);
}
function _r(e, t, n = r) {
	d(e) && (e = Tr(e));
	for (let n in e) {
		let r = e[n], i;
		i = v(r) ? "default" in r ? wn(r.from || n, r.default, !0) : wn(r.from || n) : wn(r), /* @__PURE__ */ z(i) ? Object.defineProperty(t, n, {
			enumerable: !0,
			configurable: !0,
			get: () => i.value,
			set: (e) => i.value = e
...
function Rr(e) {
	...
	return n.dirs && (b = Ii(b, null, !1, !0), b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs), n.transition && In(Mn(b.type) && Fn(b) || b, n.transition), v = b, yn(_), v;
}
var zr = (e) => {
	let t;
...
function ui(e, i) {
	...
	let { insert: o, remove: s, patchProp: c, createElement: l, createText: u, createComment: d, setText: f, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = r, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		...
		if (d = e.el = l(e.type, a, m && m.is, m), h & 8 ? p(d, e.children) : h & 16 && E(e.children, d, null, r, i, di(e, a), s, u), _ && Sn(e, null, r, "created"), te(d, e, e.scopeId, s, r), m) {
		...
		v && g.beforeEnter(d), o(d, t, n), ((f = m && m.onVnodeMounted) || v || _) && K(() => {
			try {
				f && Ui(f, r, e), v && g.enter(d), _ && Sn(e, null, r, "mounted");
			} finally {}
		}, i);
	}, te = (e, t, n, r, i) => {
		...
		if (r && fi(r, !1), (g = h.onVnodeBeforeUpdate) && Ui(g, r, n, e), f && Sn(n, e, r, "beforeUpdate"), r && fi(r, !0), d && (!e.dynamicChildren || e.dynamicChildren.length !== d.length) && (u = 0, s = !1, d = null), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(l, ""), d ? D(e.dynamicChildren, d, l, r, i, di(n, a), o) : s || ue(e, n, l, null, r, i, di(n, a), o, !1), u > 0) {
		...
		((g = h.onVnodeUpdated) || f) && K(() => {
			g && Ui(g, r, n, e), f && Sn(n, e, r, "updated");
		}, i);
	}, D = (e, t, n, r, i, a, o) => {
		...
		let s = () => {
			if (e.isMounted) {
				...
				if (fi(e, !1), l && ae(l), !m && (o = c && c.onVnodeBeforeMount) && Ui(o, d, t), fi(e, !0), s && Ce) {
					let t = () => {
		...
		t.component = e;
		let r = e.vnode.props;
		e.vnode = t, e.next = null, Yr(e, t.props, r, n), ci(e, t.children, n), He(), mn(e), Ue();
		...
		if (r !== 2 && d & 1 && l) {
			if (r === 0) l.persisted && !a[Nn] ? o(a, t, n) : (l.beforeEnter(a), o(a, t, n), K(() => l.enter(a), i));
			else {
		...
		if (g && (_ = o && o.onVnodeBeforeUnmount) && Ui(_, t, e), u & 6) _e(e.component, n, r);
			...
			h && Sn(e, null, t, "beforeUnmount"), u & 64 ? e.type.remove(e, t, n, Se, r) : l && !l.hasOnce && (a !== q || d > 0 && d & 64) ? ve(l, t, n, !1, !0) : (a === q && d & 384 || !i && u & 16) && ve(c, t, n), r && he(e);
		}
		let v = m != null && p == null;
		(g && (_ = o && o.onVnodeUnmounted) || h || v) && K(() => {
			_ && Ui(_, t, e), h && Sn(e, null, t, "unmounted"), v && (e.el = null);
		}, n);
	}, he = (e) => {
		...
		_i(c), _i(l), r && ae(r), i.stop(), a && (a.flags |= 8, me(o, e, t, n)), s && K(s, t), K(() => {
			e.isUnmounted = !0;
		}, t);
		...
		let r;
		e == null ? t._vnode && (me(t._vnode, null, null, !0), r = t._vnode.component) : v(t._vnode || null, e, t, null, null, null, n), t._vnode = e, be ||= (be = !0, mn(r), hn(), !1);
	}, Se = {
		p: v,
		um: me,
		m: pe,
...
function Pi(e, t = null, n = null, r = 0, i = null, a = !1) {
	...
	let o = g(e) ? 1 : yi(e) ? 128 : Mn(e) ? 64 : v(e) ? 4 : h(e) ? 2 : 0;
...
var ca = (e, t) => /* @__PURE__ */ qt(e, t, $i), la = "3.5.42", ua = void 0, da = typeof window < "u" && window.trustedTypes;
if (da) try {
...
var Za = typeof HTMLElement < "u" ? HTMLElement : class {}, Qa = class e extends Za {
	...
	_setAttr(e) {
		...
		let t = this.hasAttribute(e), n = t ? this.getAttribute(e) : Ya, r = E(e);
	...
	_createVNode() {
		...
		let t = Q(this._def, s(e, this._props));
...
var no = /* @__PURE__ */ Symbol("_assign"), ro = /* @__PURE__ */ Symbol("_initialValue");
function io(e, t, n) {
	return t && (e = e.trim()), n && (e = oe(e)), e;
}
var ao = {
	created(e, { modifiers: { lazy: t, trim: n, number: r } }, i) {
		e.parentNode && (e.type === "text" ? e[ro] = e.defaultValue.replace(/[\r\n]/g, "") : e.type === "textarea" && (e[ro] = e.defaultValue.replace(/\r\n?/g, "\n"))), e[no] = $a(i);
		let a = r || i.props && i.props.type === "number";
		Pa(e, t ? "change" : "input", (t) => {
			t.target.composing || e[no](io(e.value, n, a));
		}), (n || a) && Pa(e, "change", () => {
	...
	mounted(e, { value: t, modifiers: { trim: n, number: r } }) {
		let i = t ?? "", a = e[ro];
		delete e[ro], a !== void 0 && (e.type === "text" || e.type === "textarea") && e.value !== a ? e[no](io(e.value, n, r)) : e.value = i;
	},
...
}, lo = /* @__PURE__ */ s({ patchProp: Ka }, _a), uo;
function fo() {
	return uo ||= li(lo);
}
var po = ((...e) => {
...
//#endregion
//#region src/api.ts
var _o = "1.0.0", vo = class extends Error {
	statusCode;
	code;
	retryable;
	constructor(e, t) {
		super(t?.statusMessage ?? t?.message ?? `Widget API returned ${e.status}`), this.name = "WidgetApiError", this.statusCode = e.status, this.code = t?.data?.code ?? null, this.retryable = t?.data?.retryable ?? e.status >= 500;
	}
}, yo = (e) => new URL("../../api/v1/", e).toString().replace(/\/$/u, ""), bo = async (e) => new vo(e, await e.json().catch(() => null)), xo = async (e, t) => {
	let n = await fetch(e, t);
	if (!n.ok) throw await bo(n);
	return await n.json();
}, So = (e, t) => `ai-assist:session:${new URL(e).origin}:${t}`, Co = async (e, t, n) => xo(`${e}/widget/sessions`, {
	method: "POST",
...
}), wo = async (e, t) => xo(`${e}/widget/session`, {
	method: "GET",
	headers: { authorization: `Bearer ${t}` }
}), To = async (e, t) => xo(`${e}/widget/conversations`, {
	method: "POST",
	headers: {
	...
	let t = "message", n = [];
	for (let r of e.split("\n")) r.startsWith("event:") && (t = r.slice(6).trim()), r.startsWith("data:") && n.push(r.slice(5).trimStart());
	if (!n.length) return null;
	let r = JSON.parse(n.join("\n"));
	return t !== "meta" && t !== "delta" && t !== "citation" && t !== "usage" && t !== "done" && t !== "error" ? null : {
		type: t,
		data: r
	};
}, Do = async (e, t) => {
	if (!e.body) throw Error("Widget API returned an empty event stream");
	let n = e.body.pipeThrough(new TextDecoderStream()).getReader(), r = "";
	for (;;) {
		let e = await n.read();
		if (e.done) break;
		r += e.value.replace(/\r\n/gu, "\n");
	...
	let t = await fetch(`${e.apiBase}/widget/chat`, {
		method: "POST",
		headers: {
	...
	if (!t.ok) throw await bo(t);
	await Do(t, e.onEvent);
}, ko = ["data-assistant-id"], Ao = ["aria-label"], jo = { class: "chat-widget__header" }, Mo = { class: "chat-widget__title" }, No = { class: "chat-widget__status" }, Po = { class: "chat-widget__header-actions" }, Fo = ["disabled"], Io = {
	key: 0,
	class: "message-list__item"
}, Lo = { class: "chat-message chat-message--assistant" }, Ro = ["aria-busy"], zo = { class: "visually-hidden" }, Bo = {
	key: 0,
...
}, Uo = ["href"], Wo = { key: 1 }, Go = ["placeholder", "disabled"], Ko = ["disabled"], qo = ["aria-expanded"], Jo = /*#__PURE__*/ ((e, t) => {
	let n = e.__vccOpts || e;
	for (let [e, r] of t) n[e] = r;
	return n;
})(/* @__PURE__ */ Ln({
	__name: "AiAssist.ce",
	props: { assistantId: { type: String } },
	setup(e) {
		let t = e, n = yo(import.meta.url), r = Rn().replace(/[^A-Za-z0-9_-]/gu, ""), i = `ai-assist-dialog-${r}`, a = `ai-assist-message-${r}`, o = `ai-assist-status-${r}`, s = /* @__PURE__ */ B(!1), c = /* @__PURE__ */ B(!1), l = /* @__PURE__ */ B(!1), u = /* @__PURE__ */ B(null), d = /* @__PURE__ */ B(null), f = /* @__PURE__ */ B(null), p = /* @__PURE__ */ B(null), m = /* @__PURE__ */ B(null), h = /* @__PURE__ */ B([]), g = /* @__PURE__ */ B(""), _ = /* @__PURE__ */ B(), v = /* @__PURE__ */ B(), y = /* @__PURE__ */ B(), b = /* @__PURE__ */ B(), x = null, S = null, C = ca(() => ({ "--ai-assist-accent": p.value?.accentColor ?? "#275F3B" })), w = ca(() => p.value?.launcherPosition === "left"), T = ca(() => p.value?.enabled !== !1), ee = ca(() => p.value?.name ?? "Помощник магазина"), te = ca(() => c.value ? "Подключаемся…" : l.value ? "Печатает…" : T.value ? "Готов помочь с выбором упаковки" : "Временно недоступен"), E = () => t.assistantId ? So(n, t.assistantId) : null, ne = () => {
			let e = E();
			if (!e) return null;
			try {
			...
			let t = E();
			if (t) try {
				e ? window.localStorage.setItem(t, e) : window.localStorage.removeItem(t);
			} catch {}
		}, re = (e) => {
			m.value = e?.id ?? null, h.value = (e?.messages ?? []).map((e) => ({
				...e,
				citations: []
			}));
		}, ie = (e) => {
			f.value = e.expiresAt, p.value = e.config, re(e.conversation);
		}, O = async () => x || (x = (async () => {
			if (!t.assistantId) throw Error("Для виджета не указан assistant-id");
			...
			if (e) try {
				...
				if (!(e instanceof vo) || e.statusCode !== 401) throw e;
				D(null);
			}
			let r = await Co(n, t.assistantId, navigator.language || "ru-RU");
			d.value = r.sessionToken, D(r.sessionToken), ie(r);
		})().catch((e) => {
			throw x = null, u.value = e instanceof vo && e.statusCode === 404 ? "Ассистент пока недоступен на этом сайте." : "Не удалось подключить ассистента. Обновите страницу или попробуйте позже.", e;
		}).finally(() => {
			c.value = !1;
		}), x), ae = async () => {
			await ln(), b.value?.scrollTo({
				top: b.value.scrollHeight,
				behavior: "smooth"
			});
		}, k = async () => {
			s.value = !0, await ln(), v.value?.focus(), await O().catch(() => void 0), await ae();
		}, oe = () => {
			s.value = !1, ln(() => _.value?.focus());
		}, se = async () => {
			if (!(!d.value || l.value)) {
				c.value = !0, u.value = null;
				try {
					re(await To(n, d.value)), await ln(), y.value?.focus();
				} catch {
					u.value = "Не удалось начать новый диалог. Попробуйте ещё раз.";
				} finally {
					c.value = !1;
				}
			}
		}, ce = () => crypto.randomUUID(), le = async () => {
			let e = g.value.trim();
			if (!e || l.value || !T.value || !d.value && (await O().catch(() => void 0), !d.value)) return;
			g.value = "", u.value = null, l.value = !0;
			let t = (/* @__PURE__ */ new Date()).toISOString(), r = /* @__PURE__ */ Mt({
				id: ce(),
				role: "user",
				content: e,
				status: "completed",
			...
			h.value.push(r, i), await ae(), S = new AbortController();
			let a = !1;
			try {
				await Oo({
					apiBase: n,
					sessionToken: d.value,
					conversationId: m.value,
					message: e,
					signal: S.signal,
					onEvent: (e) => {
						e.type === "meta" && (m.value = e.data.conversationId, r.id = e.data.userMessageId, i.id = e.data.assistantMessageId), e.type === "delta" && (i.content += e.data.text, ae()), e.type === "citation" && i.citations.push(e.data), e.type === "error" && (a = !0, i.status = "failed", i.content ||= e.data.message), e.type === "done" && (i.status = "completed");
					}
				}), !a && i.status === "pending" && (i.status = "failed", i.content ||= "Ответ прервался. Попробуйте отправить сообщение ещё раз.");
			} catch (e) {
				if (S.signal.aborted) return;
				i.status = "failed", i.content = e instanceof vo && e.statusCode === 409 ? "Предыдущий ответ ещё формируется. Подождите немного и повторите отправку." : "Не удалось получить ответ. Попробуйте ещё раз.";
			} finally {
				S = null, l.value = !1, await ae();
			}
		}, de = (e) => {
			if (e) try {
				let t = new URL(e);
				return t.protocol === "http:" || t.protocol === "https:" ? t.toString() : void 0;
			} catch {
				return;
			}
		}, fe = (e) => {
			e.key === "Escape" && s.value && oe();
		};
		return window.addEventListener("keydown", fe), nr(() => {
			S?.abort(), window.removeEventListener("keydown", fe);
		}), (t, n) => (Y(), X("section", {
			class: he(["chat-widget", { "chat-widget--left": w.value }]),
			style: ue(C.value),
			"data-assistant-id": e.assistantId || void 0
		}, [s.value ? (Y(), X("section", {
			key: 0,
			id: i,
			class: "chat-widget__panel",
			role: "dialog",
			"aria-label": `ИИ-ассистент ${ee.value}`
		}, [
			...
			Z("ol", {
				...
				"aria-live": "polite"
			}, [h.value.length ? Ri("", !0) : (Y(), X("li", Io, [Z("article", Lo, [n[3] ||= Z("span", { class: "visually-hidden" }, "Ассистент:", -1), Li(" " + A(p.value?.greeting || "Расскажите, какая упаковка вам нужна."), 1)])])), (Y(!0), X(q, null, lr(h.value, (e) => (Y(), X("li", {
				key: e.id,
				class: "message-list__item"
			}, [Z("article", {
				class: he(["chat-message", `chat-message--${e.role}`]),
				"aria-busy": e.status === "pending"
			}, [
				Z("span", zo, A(e.role === "assistant" ? "Ассистент:" : "Вы:"), 1),
				e.content ? (Y(), X("span", Bo, A(e.content), 1)) : (Y(), X("span", Vo, [...n[4] ||= [Z("span", { "aria-hidden": "true" }, "•••", -1)]])),
				e.citations.length ? (Y(), X("ul", Ho, [(Y(!0), X(q, null, lr(e.citations, (e) => (Y(), X("li", { key: e.id }, [de(e.url) ? (Y(), X("a", {
					key: 0,
					class: "source-list__link",
					href: de(e.url),
					target: "_blank",
					rel: "noopener noreferrer"
				}, A(e.title), 9, Uo)) : (Y(), X("span", Wo, A(e.title), 1))]))), 128))])) : Ri("", !0)
			], 10, Ro)]))), 128))], 512),
			Z("form", {
				class: "chat-composer",
				...
				xn(Z("input", {
					...
					type: "text",
					name: "message",
					placeholder: p.value?.placeholder || "Напишите вопрос",
					autocomplete: "off",
					maxlength: "4000",
					disabled: c.value || l.value || !T.value || !!(u.value && !p.value),
					"aria-describedby": o
			...
			Z("p", {
				id: o,
				class: "chat-widget__note",
				role: "status"
			}, A(u.value || (T.value ? "История разговора сохранится на этом устройстве." : p.value?.maintenanceMessage || "Ассистент временно недоступен.")), 1)
		], 8, Ao)) : Ri("", !0), Z("button", {
			ref_key: "launcher",
			ref: _,
...
Xo();
//#endregion
export { Yo as elementName, Xo as registerAiAssist };
